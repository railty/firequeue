...
class Base {
    ...
    get broker() {
        if (!this._broker) {
            this._broker = (0, brokers_1.createCeleryBroker)(this.conf.CELERY_BROKER, this.conf.CELERY_BROKER_OPTIONS, this.conf.CELERY_QUEUE);
        }
        return this._broker;
    }
    get backend() {
        if (!this._backend) {
            this._backend = (0, backends_1.createCeleryBackend)(this.conf.CELERY_BACKEND, this.conf.CELERY_BACKEND_OPTIONS);
        }
