...
import { createCeleryBroker, CeleryBroker } from "../kombu/brokers";
import { createCeleryBackend, CeleryBackend } from "../backends";
...
export default class Base {
  ...
  get broker(): CeleryBroker {
    if (!this._broker) {
      this._broker = createCeleryBroker(
  ...
  get backend(): CeleryBackend {
    if (!this._backend) {
      this._backend = createCeleryBackend(
